...
export function Column({
  ...
  return (
    <div
      className="kanban-column min-w-[320px] flex-shrink-0 bg-sand-50 border border-sand-200 rounded-3xl p-6 flex flex-col gap-4 shadow-soft scroll-snap-align-start"
      data-column-id={id}
    >
      {/* Column Header */}
