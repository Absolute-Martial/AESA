...
export function TodayDashboard({
  ...
  return (
    <div className="flex h-screen bg-sand-100 dark:bg-gray-900 transition-colors">
      {/* Main Content - Flow Board */}
      <div className={`flex-1 transition-all duration-300 ${isAiPanelCollapsed ? 'mr-0' : 'mr-[380px]'}`}>
        <FlowBoard
          date={new Date()}
          stats={stats}
      ...
      {/* AI Assistant Panel - Fixed on right */}
      <div className={`fixed right-0 top-0 h-full transition-all duration-300 ${isAiPanelCollapsed ? 'w-12' : 'w-[380px]'}`}>
        <AIAssistant
